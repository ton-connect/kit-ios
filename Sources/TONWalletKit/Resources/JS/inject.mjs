...
class ExtensionTransport {
  ...
  setupMessageListener() {
    this.messageListener = (event) => {
      ...
      if (data.type === TONCONNECT_BRIDGE_RESPONSE$1 && data.source === this.source) {
...
class IOSTransport {
  ...
  /**
   * Setup listener for messages from iOS
   */
  setupMessageListener() {
    this.messageListener = (event) => {
  ...
  send(request) {
    return __async(this, null, function* () {
      if (!this.isAvailable()) {
        throw new Error("iOS webkit message handler is not available");
      }
      return new Promise((resolve, reject) => {
        var _a, _b, _c;
        const messageId = crypto.randomUUID();
        ...
        try {
          ...
          (_c = (_b = (_a = webkitWindow.webkit) == null ? void 0 : _a.messageHandlers) == null ? void 0 : _b.tonconnect) == null ? void 0 : _c.postMessage({
            type: "TONCONNECT_BRIDGE_REQUEST",
            source: this.source,
            payload: request,
            messageId
  ...
  isAvailable() {
    try {
      const webkitWindow = window;
      return typeof webkitWindow.webkit !== "undefined" && typeof webkitWindow.webkit.messageHandlers !== "undefined" && typeof webkitWindow.webkit.messageHandlers.tonconnect !== "undefined";
    } catch (e) {
      return false;
    }
  }
  /**
   * Request content script injection (no-op for iOS)
   */
  requestContentScriptInjection() {
  }
  /**
...
console.log("inject.ts loaded");
window.testparam = "testparam";
function injectTonConnectBridge() {
  console.log("injectTonConnectBridge called");
  try {
    const source = "ton-tonconnect";
    const transport = new IOSTransport(window, source);
    injectBridgeCode(
      window,
      {
        deviceInfo: {
    ...
    console.log("TonConnect bridge injected - forwarding to iOS");
  } catch (error) {
